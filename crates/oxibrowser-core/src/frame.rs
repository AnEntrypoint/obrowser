...
/// wasm builds have no Blitz render document; produce an empty snapshot until
/// an in-guest HTML parser lands (tracked as a separate wasm feature).
#[cfg(not(feature = "native"))]
fn snapshot_from_html(_url: &Url, _html: &str) -> Result<DomSnapshot> {
